                ...
                if 'external_id' in reference:
                    if ((reference['external_id'].startswith("T"))):
                        ...
                        if 'x_mitre_deprecated' in object:
                            ...
                            filtered_object = {'tactics': str(tactics), 'technique': str(technique), 'name': name , 'url': url, 'deprecated': str(deprecated) }
...
for file in alert_data:
    for line in alert_data[file]:
        ...
        #Check to see if the MITRE subTID + name validation is valid
        try:
